...
# --- NUEVO: base de descargas basada en variable de entorno ---
def _get_download_base() -> Path:
    """
    Si SIGED_HOST_DOWNLOADS está definida, úsala como base (caso Docker con volumen montado).
    Si no, usar la carpeta de Descargas del usuario (ejecución local).
    """
...
async def descargar_documentos(url: str) -> None:
    ...
    # --- AQUÍ el cambio clave: base de descarga configurable ---
